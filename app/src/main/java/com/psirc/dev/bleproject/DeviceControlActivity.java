...
public class DeviceControlActivity extends AppCompatActivity {
    ...
    private EmeraldService mBluetoothLeService;
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            mBluetoothLeService = ((EmeraldService.LocalBinder) service).getService();
            if (!mBluetoothLeService.initialize()) {
                Log.e("flow-check", "Unable to initialize Bluetooth");
                finish();
            }
            Log.e("flow-check","serviceConncection");
            // Automatically connects to the device upon successful start-up initialization.
            mBluetoothLeService.connect(mDeviceAddress,contactNumbers);
        }
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (EmeraldService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                displayData(intent.getStringExtra(EmeraldService.EXTRA_DATA));
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //mDeviceAddress = intent.getStringExtra(EXTRAS_DEVICE_ADDRESS);
        mDeviceAddress = SharedPreferencesManager.getMacAddress(this);
        ...
        Intent gattServiceIntent = new Intent(this, EmeraldService.class);
    ...
    protected void onResume() {
        ...
        if (mBluetoothLeService != null) {
            final boolean result = mBluetoothLeService.connect(mDeviceAddress,contactNumbers);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.gattservices, menu);
        if (mConnected) {
